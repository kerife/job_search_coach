...
SOURCE_PLUGIN_ROOT="${SOURCE_PLUGIN_ROOT:-$PROJECT_ROOT/plugins/job-search-coach}"
LINKEDIN_SKILL_ROOT="${LINKEDIN_SKILL_ROOT:-$SOURCE_PLUGIN_ROOT/skills/optimize-linkedin-career}"
