...
Entry: `plugins/job-search-coach/scripts/render_executive_career_dossier.py`
...
Entry: `plugins/job-search-coach/scripts/render_recruiter_practice_session.py`

Dependencies:

- `plugins/job-search-coach/scripts/validate_recruiter_practice_session.py`
- `plugins/job-search-coach/assets/recruiter-practice-session-v1.html`
...
Entry: `plugins/job-search-coach/scripts/render_private_recruiter_reply_triage.py`

Dependencies:

- `plugins/job-search-coach/scripts/validate_private_recruiter_reply_triage.py`
- `plugins/job-search-coach/assets/private-recruiter-reply-triage-v1.html`
...
Entry: `plugins/job-search-coach/scripts/render_private_recruiter_followthrough_checkpoint.py`

Dependencies:

- `plugins/job-search-coach/scripts/validate_private_recruiter_followthrough_checkpoint.py`
  - `plugins/job-search-coach/scripts/validate_private_recruiter_conversion_outcome.py`
- `plugins/job-search-coach/assets/private-recruiter-followthrough-checkpoint-v1.html`
...
Entry: `plugins/job-search-coach/scripts/render_private_recruiter_conversion_outcome.py`

Dependencies:

- `plugins/job-search-coach/scripts/validate_private_recruiter_conversion_outcome.py`
- `plugins/job-search-coach/assets/private-recruiter-conversion-outcome-v1.html`
