...
@media (forced-colors: active) { .checkpoint-card { border: 1px solid CanvasText; } .checkpoint-boundary { border: 1px solid CanvasText; border-left-width: .25rem; } .checkpoint-kicker { color: LinkText; } }
```
...
@media (forced-colors: active) { .outcome-card { border: 1px solid CanvasText; } .outcome-boundary { border: 1px solid CanvasText; border-left-width: .25rem; } .outcome-kicker { color: LinkText; } }
```
