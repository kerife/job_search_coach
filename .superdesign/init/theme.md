...
@media (forced-colors: active) {
  .market-summary, .vacancy-alignment-card, .recurrence-row, .gap-closure-route, .market-matrix th, .market-matrix td { background: Canvas; color: CanvasText; border-color: CanvasText; }
