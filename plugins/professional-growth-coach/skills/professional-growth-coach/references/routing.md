...
All bounded prose validators apply the shared normalization contract before checking privacy, markup, and Unicode-control rules. This includes percent-encoded and HTML-entity encoded forms, which must be rejected when they decode to private contact data, URLs, authorization-like text, or controls.
