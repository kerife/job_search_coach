...
COPY = {
    "es": {
        ...
        "next_safe_action_record_stop_decision": "Registra la decisión de detenerse en privado; no continúes.",
        ...
        "focus_decline": "Detener: no hay traspaso a preparación privada",
    ...
    "en": {
        ...
        "next_safe_action_record_stop_decision": "Record the stop decision privately; do not continue.",
        ...
        "focus_decline": "Stop: no private preparation handoff",
