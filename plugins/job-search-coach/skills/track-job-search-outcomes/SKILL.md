---
name: track-job-search-outcomes
...
```bash
python3 plugins/job-search-coach/scripts/summarize_outcomes.py OUTCOMES.csv --window 30 --as-of YYYY-MM-DD
```
...
```bash
python3 plugins/job-search-coach/scripts/summarize_outcomes.py OUTCOMES.csv --window 30 --as-of YYYY-MM-DD --candidate-id CANDIDATE_ID
```
