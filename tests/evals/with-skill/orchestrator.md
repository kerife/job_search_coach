...
- Routing: Pass — the title conflict routes to \`optimize-linkedin-career\` with \`blocked_on_evidence\`.
...
selected_module: discover-high-value-career-paths
...
- Routing: Pass — Candidate A routes to \`optimize-linkedin-career\` and Candidate B to \`discover-high-value-career-paths\`; both return the router contract.
