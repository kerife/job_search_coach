...
Candidate: JSC-CASE-B
Evidence
- verified: none; no inspectable source supplied
- candidate-reported: JSC-FACT-B-01 role_family=customer_operations; evidence_tier=transferable
- candidate-reported: JSC-FACT-B-02 capability_family=revenue_ownership; capability_state=unsupported
